...
assert!(css_url.to_string() == "http://servo.github.io/rust-url/main.css".to_string());
```
...
impl Show for Url {
    fn fmt(&self, formatter: &mut Formatter) -> Result<(), FormatError> {
        write::write_url(self, formatter).map_err(|_io_error| fmt::WriteError)
    }
}

impl Show for SchemeData {
    fn fmt(&self, formatter: &mut Formatter) -> Result<(), FormatError> {
        write::write_scheme_data(self, formatter).map_err(|_io_error| fmt::WriteError)
    }
}

impl Show for RelativeSchemeData {
    fn fmt(&self, formatter: &mut Formatter) -> Result<(), FormatError> {
        write::write_relative_scheme_data(self, formatter).map_err(|_io_error| fmt::WriteError)
    }
}
