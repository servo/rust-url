...
pub struct Input<'i> {
    chars: str::Chars<'i>,
    log_syntax_violation: Option<&'i Fn(&'static str)>,
}
...
impl<'i> Input<'i> {
    ...
    pub fn with_log(original_input: &'i str, log_syntax_violation: Option<&'i Fn(&'static str)>)
                    -> Self {
        ...
        Input { chars: input.chars(), log_syntax_violation: log_syntax_violation }
    }
