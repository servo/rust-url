...
pub fn set_host(url: &mut Url, new_host: &str) -> Result<(), ()> {
    ...
    let opt_port;
    {
        ...
        let result = Parser::parse_host(Input::new(new_host),
                                        SchemeType::from(scheme), |_| ());
        match result {
            Ok((h, remaining)) => {
                host = h;
...
pub fn set_hostname(url: &mut Url, new_hostname: &str) -> Result<(), ()> {
    ...
    let result = Parser::parse_host(Input::new(new_hostname),
                                    SchemeType::from(url.scheme()), |_| ());
...
pub fn set_port(url: &mut Url, new_port: &str) -> Result<(), ()> {
    let result;
    {
        ...
        result = Parser::parse_port(Input::new(new_port),
                                    |_| (), || default_port(scheme), Context::Setter)
    }
